...
bot_red4 = PlayerHandler("bot_red4", TeamID.RED, bot=bot_red)
game.add_players([bot_blue1, bot_red1, bot_blue2, bot_red2, bot_blue3, bot_red3, bot_blue4, bot_red4])
...
while True:
    ...
    while not done:
        ...
        actions[0] = bot_blue1.step(game)
        actions[1] = bot_red1.step(game)
        actions[2] = bot_blue2.step(game)
        actions[3] = bot_red2.step(game)
        actions[4] = bot_blue3.step(game)
        actions[5] = bot_red3.step(game)
        actions[6] = bot_blue4.step(game)
        actions[7] = bot_red4.step(game)
